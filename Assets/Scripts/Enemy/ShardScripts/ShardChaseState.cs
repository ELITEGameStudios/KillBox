...
public class ShardChaseState : BossStateData
{
    ...
    public ShardChaseState(ShardBoss bossBase, float chaseTime, float maxSpeed, float maxAccel, float aDrag, float rSpeed, bool fires = false) : base(bossBase) // need to test if this auto-calls the super constructor
    {
        shardData = bossBase;
