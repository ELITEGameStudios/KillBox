...
public class GuardianBoss : BossBase
{
    ...
    void Awake()
    {
        ...
        whipState = new GuardianMainState(this, "WHIP", 70, 18, targetTime: 7, rotationSpeed: -320, startShootingTime: 7, whip: true, maxEntities: 1);
        ...
        angryWhipState = new GuardianMainState(this, "WHIP", 25, 12, targetTime: 7, rotationSpeed: -320, startShootingTime: 1, whip: true, maxEntities: 2);
