...
[System.Serializable]
public class MidasOtherState : BossStateData
{
    MidasBoss midasData;
    ...
    public MidasOtherState(MidasBoss bossBase, float time, float speed, float force, float dist, float fr, float init, int index) : base(bossBase){
        midasData = bossBase;
        this.stateTime = time;
        this.maxSpeed = speed; 
        this.accel = force;
    ...
    void FiringUpdate(){
        ...
        {
            midasData.otherShooter[index].Shoot();
