...
public class WeaponItemList : MonoBehaviour
{
    ...
    public readonly List<WeaponItem> weapon_items = new List<WeaponItem>
    {
        ...
        new WeaponItem("Speed Revolver", WeaponLibrary.speedRevolver, price_input: 13, tier_input: 2, loopyDesc: "A quick backup weapon made to get you out of tricky situations"),
        ...
        new WeaponItem("Tactical AR", WeaponLibrary.tacticalAR, price_input: 12, tier_input: 1, loopyDesc: "A strong and reliable weapon you can always count on!"),
        new WeaponItem("Heavy AR", WeaponLibrary.heavyAR, price_input: 22, tier_input: 2, loopyDesc: "A high damage weapon with a steady fire rate and can penetrate through walls"),
        ...
        new WeaponItem("Speedy Burst AR", WeaponLibrary.speedyBurstRifle, price_input: 10, tier_input: 1, loopyDesc: "Lightning speed bursts with even more strength and precision than the last!"),
        ...
        new WeaponItem("Tactical SMG", WeaponLibrary.tacticalSmg, price_input: 10, tier_input: 1, loopyDesc: "An upgraded version of the light SMG in every sense of the word. Very reliable in sustained close combat"),
        ...
        new WeaponItem("Tri-Shot", WeaponLibrary.triShotgun, price_input: 10, tier_input: 1, loopyDesc: "A much more optimized shotgun with 3 shells at a time, a moderate fire rate and good damage"),
        new WeaponItem("Penta-Shot", WeaponLibrary.pentaShotgun, price_input: 18, tier_input: 2, loopyDesc: "You thought 3 bullets wasnt enough with the tri-shotgun? Heres 5!"),
        new WeaponItem("Dual Action", WeaponLibrary.dualActionShotgun, price_input: 20, tier_input: 2, loopyDesc: "Quick Bursts of 2 deadly shots and massive reach"),
        ...
        new WeaponItem("Musket", WeaponLibrary.musket, price_input: 10, tier_input: 1, loopyDesc: "A still strong and precise bullet that goes through walls! "),
        new WeaponItem("Heavy Rifle", WeaponLibrary.heavyRifle, price_input: 26, tier_input: 2, loopyDesc: "Faster, stronger, and deadlier. Will absolutely tear through walls and enemies alike!"),
        ...
        new WeaponItem("Double Launcher", WeaponLibrary.doubleLauncher, price_input: 8, tier_input: 1, loopyDesc:"You thought one explosion at a time was broken? Heres TWO!"),
